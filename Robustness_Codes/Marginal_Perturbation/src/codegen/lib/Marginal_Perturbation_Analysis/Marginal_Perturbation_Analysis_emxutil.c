 ...
 * File: Marginal_Perturbation_Analysis_emxutil.c
 *
...
{
  emxFree_real_T(&pStruct->delta_val);
  emxFree_real_T(&pStruct->S_sd_pert);
  emxFree_real_T(&pStruct->S_pert);
  emxFree_real_T(&pStruct->T_sd_pert);
  emxFree_real_T(&pStruct->T_pert);
  emxFree_real_T(&pStruct->Acc_Rej_Bound);
  emxFree_real_T(&pStruct->R);
  emxFree_real_T(&pStruct->a);
  emxFree_real_T(&pStruct->delta_weights);
  emxFree_real_T(&pStruct->psi_val);
  emxFree_real_T(&pStruct->perturbation_marker);
}
...
{
  emxInit_real_T(&pStruct->phi_A, 2);
  emxInit_real_T(&pStruct->phi_B, 2);
}
...
{
  emxInit_real_T(&pStruct->delta_val, 2);
  emxInit_real_T(&pStruct->S_sd_pert, 2);
  emxInit_real_T(&pStruct->S_pert, 2);
  emxInit_real_T(&pStruct->T_sd_pert, 2);
  emxInit_real_T(&pStruct->T_pert, 2);
  emxInit_real_T(&pStruct->Acc_Rej_Bound, 2);
  emxInit_real_T(&pStruct->R, 2);
  emxInit_real_T1(&pStruct->a, 3);
  emxInit_real_T(&pStruct->delta_weights, 2);
  emxInit_real_T(&pStruct->psi_val, 2);
  emxInit_real_T2(&pStruct->perturbation_marker, 1);
}
...
/*
 * File trailer for Marginal_Perturbation_Analysis_emxutil.c
 *
 * [EOF]
 */
