 ...
 * File: Joint_Perturbation_Analysis_emxutil.c
 *
...
{
  emxFree_real_T(&pStruct->phi_A);
  emxFree_real_T(&pStruct->phi_A_marg_not_k);
  emxFree_real_T(&pStruct->phi_C);
  emxFree_real_T(&pStruct->phi_C_Cond_not_k);
  emxFree_real_T(&pStruct->phi_C_marg_not_k);
}
...
{
  emxInit_real_T2(&pStruct->T, 1);
  emxInit_real_T(&pStruct->A, 2);
  emxInit_real_T1(&pStruct->C, 3);
  emxInit_real_T2(&pStruct->YA, 1);
  emxInit_real_T(&pStruct->YC, 2);
}
...
{
  emxInit_real_T2(&pStruct->phi_A, 1);
  emxInit_real_T(&pStruct->phi_A_marg_not_k, 2);
  emxInit_real_T(&pStruct->phi_C, 2);
  emxInit_real_T(&pStruct->phi_C_Cond_not_k, 2);
  emxInit_real_T(&pStruct->phi_C_marg_not_k, 2);
}
...
/*
 * File trailer for Joint_Perturbation_Analysis_emxutil.c
 *
 * [EOF]
 */
